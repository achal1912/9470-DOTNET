...
namespace LINQTOSQL01
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            var result = from student in db.StudentDetail
                         select new
                         {
                             Id = student.Sid,
                             Name = student.SName,
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            TextBox txtage = (TextBox)GridView1.FooterRow.FindControl("txtfAge");
            StudentDetail student = new StudentDetail();
            student = db.StudentDetail.Single(x => x.Sid == Sid);
            student.SetSName(txtname.Text);
            student.Location = txtlocation.Text;
            student.Gender = txtgender.Text;
            student.Age = txtage.Text;
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            StudentDetail student = new StudentDetail();
            student = db.StudentDetail.Single(x =>x.Sid == sid);
            db.StudentDetail.DeleteOnSubmit(student);
            db.SubmitChanges();
            BindGridview();
            lblresult.ForeColor = Color.Green;
